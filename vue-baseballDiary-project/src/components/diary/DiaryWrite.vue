          ...
          <div>
            ...
            <div>
              ...
              <div class="box">
                ...
                <div class="score">
                  <div v-if="diary.awayScore || diary.awayScore == '0'">
                    {{ diary.awayScore }}
                  </div>
                  <div v-else>-</div>
                </div>
              ...
              <div class="box">
                <!-- homelogo&score -->
                <div class="score">
                  <div v-if="diary.homeScore || diary.homeScore == '0'">
                    {{ diary.homeScore }}
                  </div>
                  <div v-else>-</div>
                </div>
            ...
            <div class="div-write-score away">
              <div>
                ...
                <select
                  ...
                  name="awayTeam"
                  id="awayTeam"
                  v-model="diary.awayTeam"
                >
                  <option selected disabled>팀을 선택해주세요</option>
            ...
            <div class="div-write-score home">
              <div>
                ...
                <select
                  ...
                  name="homeTeam"
                  id="homeTeam"
                  v-model="diary.homeTeam"
                >
                  <option value="" selected disabled>팀을 선택해주세요</option>
                  <option value="0">선택 안함</option>
                  <option value="1">두산</option>
                  <option value="2">LG</option>
                  <option value="3">한화</option>
...
const disabled = computed(() => {
  return !(diary.value.title.length > 0);
});

const writeDiary = function () {
  if (
    (resultChk.value == true &&
      diary.value.homeTeam != null &&
      diary.value.homeScore != null &&
      diary.value.awayTeam != null &&
      diary.value.awayScore != null) ||
    resultChk.value == false
  ) {
    formData.append(
      "diary",
